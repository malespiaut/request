...
static void
SplitCurve_r(vec3_t p1, vec3_t p2, vec3_t p3, vec3_t p4, vec3_t* dest, int len)
{
  vec3_t p12, p23, p34;
  vec3_t p123, p234;
  vec3_t p1234;
...
static void
SplitCurve(vec3_t p1, vec3_t p2, vec3_t p3, vec3_t p4, vec3_t* dest, int len)
{
  dest[0] = p1;
  dest[len - 1] = p4;
...
static void
DrawCurve(vec3_t p1, vec3_t p2, vec3_t p3, vec3_t p4, int len)
{
  int i;
...
static void
DrawCurvePlane(brush_t* b, plane_t* p, int len, int splits)
{
  int i;
...
void
DrawBrush_Q3Curve(int vport, brush_t* b, int col, int selected)
{
  int i;
  plane_t* p;
...
void
CurveGetPoints(brush_t* b, vec3_t* bverts, plane_t* p, vec3_t* dpoints, vec3_t* tpoints, int splits)
{
  int i;
