    ...
    if (sel_ent != NULL)
    {
      ...
      for (e1 = M.display.esel; e1; e1 = e1->Next)
      {
        if (e1->Entity == sel_ent)
        {
          ...
          found = TRUE;
          if (e1->Last != NULL)
            e1->Last->Next = e1->Next;
          if (e1->Next != NULL)
            e1->Next->Last = e1->Last;
          if (e1 == M.display.esel)
            M.display.esel = e1->Next;
