...
void
SetTexture(texdef_t* t, char* name)
{
...
void
InitTexdef(texdef_t* t)
{
  SetTexture(t, texturename);
}

static void
MoveTexdef(texdef_t* td, int dir)
{
...
static void
MoveCurveV(brush_t* b, int i, int dir, float mx, float my)
{
  switch (dir)
  {
    case MOVE_LEFT:
...
static void
ScaleTexdef(texdef_t* td, int dir)
{
  switch (dir)
  {
    case MOVE_LEFT:
