...
const char*
GetKeyValue(entity_t* ent, const char* key)
{
  int i;
  int found;
...
void
CreateKeyValue(entity_t* ent, const char* key, const char* value)
{
...
void
RemoveKeyValue(entity_t* ent, const char* key)
{
  int i, j;
  int found;
...
int
GetTargetNum(entity_t* e, const char* key)
{
  const char* v;
